...
#define UML_JMPT(block, index, table, count, chain_count)     do { using namespace uml; block.append().jmpt(index, table, count, chain_count); } while (0)
...
#define UML_STORE(block, base, index, src, size, scale)       do { using namespace uml; block.append().store(base, index, src, size, scale); } while (0)
...
#define UML_WRITE(block, addr, src, size, space)              do { using namespace uml; block.append().write(addr, src, size, space); } while (0)
#define UML_WRITEM(block, addr, src, mask, size, space)       do { using namespace uml; block.append().writem(addr, src, mask, size, space); } while (0)
#define UML_READ_NOFP(block, dst, addr, size, space)          do { using namespace uml; block.append().read(dst, addr, size, space, true); } while (0)
#define UML_READM_NOFP(block, dst, addr, mask, size, space)   do { using namespace uml; block.append().readm(dst, addr, mask, size, space, true); } while (0)
#define UML_WRITE_NOFP(block, addr, src, size, space)         do { using namespace uml; block.append().write(addr, src, size, space, true); } while (0)
#define UML_WRITEM_NOFP(block, addr, src, mask, size, space)  do { using namespace uml; block.append().writem(addr, src, mask, size, space, true); } while (0)
...
#define UML_DSTORE(block, base, index, src, size, scale)      do { using namespace uml; block.append().dstore(base, index, src, size, scale); } while (0)
...
#define UML_DWRITE(block, addr, src, size, space)             do { using namespace uml; block.append().dwrite(addr, src, size, space); } while (0)
#define UML_DWRITEM(block, addr, src, mask, size, space)      do { using namespace uml; block.append().dwritem(addr, src, mask, size, space); } while (0)
#define UML_DREAD_NOFP(block, dst, addr, size, space)         do { using namespace uml; block.append().dread(dst, addr, size, space, true); } while (0)
#define UML_DREADM_NOFP(block, dst, addr, mask, size, space)  do { using namespace uml; block.append().dreadm(dst, addr, mask, size, space, true); } while (0)
#define UML_DWRITE_NOFP(block, addr, src, size, space)        do { using namespace uml; block.append().dwrite(addr, src, size, space, true); } while (0)
#define UML_DWRITEM_NOFP(block, addr, src, mask, size, space) do { using namespace uml; block.append().dwritem(addr, src, mask, size, space, true); } while (0)
...
#define UML_FSSTORE(block, base, index, src)                  do { using namespace uml; block.append().fsstore(base, index, src); } while (0)
#define UML_FSREAD(block, dst, addr, space)                   do { using namespace uml; block.append().fsread(dst, addr, space); } while (0)
#define UML_FSWRITE(block, addr, src, space)                  do { using namespace uml; block.append().fswrite(addr, src, space); } while (0)
#define UML_FSMOV(block, dst, src)                            do { using namespace uml; block.append().fsmov(dst, src); } while (0)
#define UML_FSMOVc(block, cond, dst, src)                     do { using namespace uml; block.append().fsmov(cond, dst, src); } while (0)
#define UML_FSTOINT(block, dst, src, size, round)             do { using namespace uml; block.append().fstoint(dst, src, size, round); } while (0)
#define UML_FSFRINT(block, dst, src, size)                    do { using namespace uml; block.append().fsfrint(dst, src, size); } while (0)
#define UML_FSFRFLT(block, dst, src, size)                    do { using namespace uml; block.append().fsfrflt(dst, src, size); } while (0)
...
#define UML_FSNEG(block, dst, src)                            do { using namespace uml; block.append().fsneg(dst, src); } while (0)
#define UML_FSABS(block, dst, src)                            do { using namespace uml; block.append().fsabs(dst, src); } while (0)
#define UML_FSSQRT(block, dst, src)                           do { using namespace uml; block.append().fssqrt(dst, src); } while (0)
#define UML_FSRECIP(block, dst, src)                          do { using namespace uml; block.append().fsrecip(dst, src); } while (0)
#define UML_FSRSQRT(block, dst, src)                          do { using namespace uml; block.append().fsrsqrt(dst, src); } while (0)
...
#define UML_FDSTORE(block, base, index, src)                  do { using namespace uml; block.append().fdstore(base, index, src); } while (0)
#define UML_FDREAD(block, dst, addr, space)                   do { using namespace uml; block.append().fdread(dst, addr, space); } while (0)
#define UML_FDWRITE(block, addr, src, space)                  do { using namespace uml; block.append().fdwrite(addr, src, space); } while (0)
#define UML_FDMOV(block, dst, src)                            do { using namespace uml; block.append().fdmov(dst, src); } while (0)
#define UML_FDMOVc(block, cond, dst, src)                     do { using namespace uml; block.append().fdmov(cond, dst, src); } while (0)
#define UML_FDTOINT(block, dst, src, size, round)             do { using namespace uml; block.append().fdtoint(dst, src, size, round); } while (0)
#define UML_FDFRINT(block, dst, src, size)                    do { using namespace uml; block.append().fdfrint(dst, src, size); } while (0)
#define UML_FDFRFLT(block, dst, src, size)                    do { using namespace uml; block.append().fdfrflt(dst, src, size); } while (0)
#define UML_FDRNDS(block, dst, src)                           do { using namespace uml; block.append().fdrnds(dst, src); } while (0)
...
#define UML_FDNEG(block, dst, src)                            do { using namespace uml; block.append().fdneg(dst, src); } while (0)
#define UML_FDABS(block, dst, src)                            do { using namespace uml; block.append().fdabs(dst, src); } while (0)
#define UML_FDSQRT(block, dst, src)                           do { using namespace uml; block.append().fdsqrt(dst, src); } while (0)
#define UML_FDRECIP(block, dst, src)                          do { using namespace uml; block.append().fdrecip(dst, src); } while (0)
#define UML_FDRSQRT(block, dst, src)                          do { using namespace uml; block.append().fdrsqrt(dst, src); } while (0)
