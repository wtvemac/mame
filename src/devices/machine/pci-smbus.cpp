...
smbus_device::smbus_device(const machine_config &mconfig, const char *tag, device_t *owner, uint32_t clock)
	...
	m_hst_cnt_cb(*this),
	m_hst_sts_cb(*this),
	m_hst_aux_cnt_cb(*this),
	m_hst_aux_sts_cb(*this),
	m_hst_blkb_r_cb(*this, 0),
	m_hst_blkb_w_cb(*this)
{
}
...
{
	if(m_hst_blkb_r_cb.isunset())
		return host_block_db;
	else
		return m_hst_blkb_r_cb();
}
